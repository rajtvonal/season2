const WEATHER_TYPES = {
  ...
  "felhős napos": { icon: "🌤️", label: "Felhős napos" },
  felhosnapos: { icon: "🌤️", label: "Felhős napos" },
  felhős: { icon: "☁️", label: "Felhős" },
  felhos: { icon: "☁️", label: "Felhős" },
  "kicsit esős": { icon: "🌦️", label: "Kicsit esős" },
  kicsitesos: { icon: "🌦️", label: "Kicsit esős" },
  "nagyon esős": { icon: "🌧️", label: "Nagyon esős" },
  nagyondesos: { icon: "🌧️", label: "Nagyon esős" },
  nagyonesos: { icon: "🌧️", label: "Nagyon esős" }
};
